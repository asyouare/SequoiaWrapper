...
public final class DecimalObject {
    ...
    public double doubleValue(){
        return value.setScale(fraction,RoundingMode).doubleValue();
    }
    ...
    public DecimalObject add(String v){
        ...
        value = value.add(b1).setScale(fraction,RoundingMode);
        return this;
    }
    public DecimalObject add(DecimalObject v){
        value = value.add(v.getValue()).setScale(fraction,RoundingMode);
        return this;
    }
    ...
    public DecimalObject sub(String v) {
        BigDecimal b1 = new BigDecimal(v);
        value = value.subtract(b1).setScale(fraction,RoundingMode);
        return this;
    }
    public DecimalObject sub(DecimalObject v){
        value = value.subtract(v.getValue()).setScale(fraction,RoundingMode);
        return this;
    }
    ...
    public DecimalObject subBy(String v) {
        BigDecimal b1 = new BigDecimal(v);
        b1.subtract(value).setScale(fraction,RoundingMode);
        return this;
    }
    public DecimalObject subBy(DecimalObject v){
        value = v.getValue().subtract(value).setScale(fraction,RoundingMode);
        return this;
    }
    ...
    public DecimalObject mul(String v) {
        BigDecimal b1 = new BigDecimal(v);
        value = value.multiply(b1).setScale(fraction,RoundingMode);
        return this;
    }
    public DecimalObject mul(DecimalObject v){
        value = value.multiply(v.getValue()).setScale(fraction,RoundingMode);
        return this;
    }
